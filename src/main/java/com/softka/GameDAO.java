...
public class GameDAO {
  ...
  //DEPENDENCIA, PORQUE EL DAO NECESITA SU CONEXIÓN PARA PODER INTERACTUAR CON LA DB   
 SQLConnection connection; 
    ...
    public List<Game> getGamesByUser(int idPlayer){
      String sqlStatementSearchPlayer= "SELECT IdRondaActual,acumulateReward FROM Game WHERE IdJugador IN ('" + idPlayer + "')";
    ...
    public void saveGame(Game game){
        ...
        String executeInsert = "INSERT INTO Game (IdRondaActual,IdJugador,acumulateReward) ";
