...
import com.softka.DAO.*;
//acumulado 4, jugar alejandro, current 3; --> this
//acumulado 10, jugar miguel, current 1; --> this

public class Game {
    public List<Round> rounds; // rondas
    public int accumulatedReward; // puntaje del jugador
    public Player player; // información del jugador
    public GameDAO gameDao; // Data Access Object de interacción con la tabla de Game.
    public int CurrentRound; // Flag
    ...
    public void playGame(Player player) {
        ...
        for (Round round : this.rounds) {
            ...
            Question currentQuestion = round.getQuestion();// Solo coloca el punto de interrupción aqui, el resto lo
                                                           // quitas
            ...
            System.out.println("Accumulated Reward: " + this.accumulatedReward); // se le muestra el acumulado del
                                                                                 // momento
    ...
    public void askNext() {
        ...
        try {
            ...
            if (respuesta <= 0 || respuesta >= 3) { // no se permiten valores por fuera del rango
                ...
                System.out.println(
                        String.format("you decided finish the game, thank you for your time. Your reward is %d",
